...
- (NSDate*)dateWith0AMTime
{
   return [NSDate date:self WithHour:0 andMinutes:0];
}

- (NSDate*)dateWith23PMTime
{
    return [NSDate date:self WithHour:23 andMinutes:59];
}

+ (NSDate*)date:(NSDate*)date WithHour:(NSUInteger)hour andMinutes:(NSUInteger)minutes
{
...
- (NSString*)formatDateAndTimeToStrFull
{
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
...
- (NSString*)formatNaturalLanguage
{
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
...
+ (NSDate*)dateFromRailsString:(NSString*)railsDateString
{
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
    [formatter setDateFormat:@"yyyy-MM-dd'T'HHmmss.SSZZZZZ"];
    NSString *clearedString = [railsDateString stringByReplacingOccurrencesOfString:@":" withString:@""];
    
    return [formatter dateFromString:clearedString];
}
